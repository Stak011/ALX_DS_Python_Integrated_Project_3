...
class FieldDataProcessor:
    ...
    def weather_station_mapping(self):
        ...
        #self.df['Weather_station'].map( = self.weather_df['Weather_station']
        self.df = self.df.merge(weather_df[['Field_ID', 'Weather_station']], on='Field_ID', how='left')
        return self.df
    ...
    def process(self):
        ...
        self.rename_columns()
        self.apply_corrections(column_name='Crop_type', abs_column='Elevation')
